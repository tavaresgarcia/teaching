...
OLS = lm_robust(weeksm1 ~ morekids, se_type = "stata")
summary(OLS)
...
# instrument.
linearHypothesis(OLS.first1, c("samesex = 0"), test = "F")
...
# (ii) 
linearHypothesis(TSLS1, c("attend_v=attend_m"))

linearHypothesis(TSLS1, c("attend_v=attend_n"))

linearHypothesis(TSLS1, c("attend_v=attend_m", "attend_v=attend_n"))
